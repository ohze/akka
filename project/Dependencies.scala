...
object Dependencies {
  ...
  val docs = l ++= Seq(Test.scalatest, Test.junit, Docs.sprayJson.value, Docs.gson, Provided.levelDB)
  ...
  lazy val streamTestkit = l ++= Seq(Test.scalatest, Test.scalacheck.value, Test.junit)
