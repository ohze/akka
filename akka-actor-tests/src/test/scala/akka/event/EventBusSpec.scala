...
class ActorEventBusSpec(conf: Config) extends EventBusSpec[
  MyActorEventBus#Event, MyActorEventBus#Classifier, MyActorEventBus#Subscriber, MyActorEventBus
]("ActorEventBus", conf) {
  import akka.event.ActorEventBusSpec._

  def this() = this(ConfigFactory.parseString("akka.actor.debug.event-stream = on").withFallback(AkkaSpec.testConf))
...
class ScanningEventBusSpec extends EventBusSpec[
  MyScanningEventBus#Event, MyScanningEventBus#Classifier, MyScanningEventBus#Subscriber, MyScanningEventBus
]("ScanningEventBus") {
...
class LookupEventBusSpec extends EventBusSpec[
  MyLookupEventBus#Event, MyLookupEventBus#Classifier, MyLookupEventBus#Subscriber, MyLookupEventBus
]("LookupEventBus") {
